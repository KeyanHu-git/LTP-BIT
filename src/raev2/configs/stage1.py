...
class DiscriminatorArchConfig:
    ...
    dino_ckpt_path: str = "weights/encoders/dino_vit_small_patch8_224.pth"
    ks: int = 9
    norm_type: str = "bn"
...
class GanLossConfig:
    ...
    gram_start: int = 0  # epoch
    gram_start_step: Optional[int] = None
    gram_layers: Optional[list[str]] = None
    gram_layer_weights: Optional[list[float]] = None
    gram_mode: str = "legacy"
    gram_input_range: str = "minus_one_one"
    gram_clamp_input: bool = False
    gram_weights_path: Optional[str] = None
    gram_pooling: str = "max"
