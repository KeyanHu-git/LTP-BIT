...
DEFAULT_CKPT_DIR = Path(__file__).resolve().parents[4] / "weights" / "encoders" / "dinov3"
DEFAULT_REPO_DIR = DEFAULT_CKPT_DIR / "repo"
...
def load_dinov3(model_name):
    ...
    if repo_dir is None and (DEFAULT_REPO_DIR / "hubconf.py").is_file():
